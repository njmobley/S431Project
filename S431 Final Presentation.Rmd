...
agehist <-ggplot(data = na.omit(kki),aes(group = PrimaryDiagnosis, y = mABC_AGE, colour = PrimaryDiagnosis)) + geom_histogram()+ylab("Age (Years)")+theme_classic() 
=======
...
>>>>>>> f2576687999bbfec0539903f5db2793d48fbfd3b
```
