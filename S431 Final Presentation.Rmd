...
agehist <-ggplot(data = na.omit(kki),aes(x = mABC_AGE, colour = PrimaryDiagnosis, fill=PrimaryDiagnosis)) + geom_histogram(fill="white")+ylab("Age (Years)")+theme_classic() 
```
...
```{r, fig.height=2, fig.width=5, fig.align="center", include=FALSE}
agehist
```
